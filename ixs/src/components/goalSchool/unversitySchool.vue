<template>
    <div>
          ...
          <el-button type="primary" @click="searchGoalSchool(query)" :disabled="!canSearch">搜索</el-button>
          <el-button type="primary" @click="schoolSituation(query)" :disabled="!canSearch" v-if="showSchoolSituation">学校情况</el-button><br>
      </el-form>
		</div>
</template>
<script>
