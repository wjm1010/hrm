  ...
  bind(el, binding, vnode, oldVnode) {
    ...
    const moveDown = (e) => {
      ...
      document.onmousemove = function(e) {
        ...
        const paddingTop = getComputedStyle(el.firstElementChild, false)['padding-top'].replace(/\px/g, '')
        const paddingLeft = getComputedStyle(el.firstElementChild, false)['padding-left'].replace(/\px/g, '')

        // 移动当前元素
        dragDom.style.left = `${l + styL - paddingLeft}px`
        dragDom.style.top = `${t + styT - paddingTop}px`
