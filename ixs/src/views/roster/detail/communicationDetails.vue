<template>
  ...
  <div class="main">
    ...
    <ul class="statistics">
      <li><span>总沟通数：</span><b class="color-green">{{communicationNumber.sumRecord}}</b></li>
      <li><span>有效沟通数：</span><b class="color-green">{{communicationNumber.validRecord}}</b></li>
      <li><span>无效沟通数：</span><b class="color-green">{{communicationNumber.invalidRecord}}</b></li>
    </ul>
    <expand-table
      :pagination="paging"
      @get-list="getList"
