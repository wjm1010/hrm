<template>
  <div class="offest-pos">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="科目" prop="subjectId">
                ...
                <el-button type="text" @click="btnExamination(query)">考情分析</el-button>
              </el-form-item>
            </el-col> 
            <el-col :span="8">
              <el-form-item label="教材版本" prop="versionId">
                ...
                <el-button type="text" @click="learningAnalysis(query)">学情分析</el-button>
              </el-form-item>
            </el-col>                   
          </el-row>      
          <el-row>
            <el-col :span="7">
              <el-form-item label="考试分数" prop="scoresTotal">
                <el-input v-model="query.scores" placeholder="分数" style="width: 91px"></el-input>
                <span>/</span>
                <el-input v-model="query.scoresTotal" placeholder="总分" style="width: 91px"></el-input>
              </el-form-item>          
            </el-col>
            <el-col :span="7">
    ...
    <div class="btn-pos">
      <el-button type="palin" @click="showDialog(index)">删除</el-button>
    </div>
...
@import '../../../../../styles/student/material/component/learnSituation/index'
</style>
