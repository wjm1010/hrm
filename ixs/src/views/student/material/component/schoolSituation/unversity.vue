<template>
    ...
    <div>
      ...
      <ul class="font-body">
        <li v-if="query.examination_type">
          <div class="float-left">
            <span>考试类型：</span>
          </div>				
          <div class="margin-left-75">
            <span>{{query.examination_type_name}}</span>
          </div>				
        </li><br>
        <li v-if="query.score">
          <div class="float-left">
        ...
        <li v-if="query.examination_analysis">
          <div class="float-left">
            <span>考试分析：</span>
          </div>				
          <div class="margin-left-75">
            <span>{{query.examination_analysis}}</span>
          </div>
        </li><br>
        <li v-if="query.enrollment_rate">
          <div class="float-left">
            <span>名校录取率：</span>
          </div>				
          <div class="margin-left-75">
            <span>{{query.enrollment_rate}}</span>
          </div>
        </li><br>
        <li v-if="query.bark">
          <div class="float-left">
