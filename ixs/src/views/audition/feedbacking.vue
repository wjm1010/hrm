<template>
  ...
  <div class="dashboard-container">
     <el-row>
      <el-form inline label-width="150px" ref="form" :model="query">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { 'value': 'subjectGrade', 'text': '年级' },
          { 'value': 'areaName', 'text': '地区' },
          { 'value': 'earliestLessonTime', 'text': '试听课时间', sortable: 'custom', width: 140 },
          { 'value': 'suggestion', 'text': '反馈内容' },
    ...
    methods: {
      ...
      // list
      postListData(query) {
        return this.$http.post('order_feedbackFollowUp', query, { paging: this.paging })
      },
      getList() {
        this.loading = true
