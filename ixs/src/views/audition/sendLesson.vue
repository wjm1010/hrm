...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { text: '申请时间', value: 'applyTime', sortable: 'custom', width: 150 },
          { text: '申请人', value: 'applyUser' },
          { text: '处理人', value: 'dealUser' },
          { text: '下次沟通时间', value: 'nextCommunicationTime', sortable: 'custom', width: 150 },
    ...
    methods: {
      ...
      // list
      postListData(query) {
        return this.$http.post('order_start', query, { paging: this.paging })
      },
      getList() {
        this.loading = true
