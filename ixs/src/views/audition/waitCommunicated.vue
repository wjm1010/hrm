...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { text: '年级', value: 'subjectGrade' },
          { text: '地区', value: 'areaName' },
          { text: '试听课时间', value: 'earliestLessonTime', sortable: 'custom', width: 140 },
          { text: '下次沟通时间', value: 'nextCommunicationTime', sortable: 'custom', width: 140 },
          { text: '申请时间', value: 'applyTime', sortable: 'custom', width: 140 },
        ...
        options: {
          ...
          users: [],
          opt: [
            { key: 'noTrialClass', value: '未上体验课' },
            { key: 'hasTrialClass', value: '已上体验课' },
            { key: 'trialClassTips', value: '24小时试听课提醒' },
    ...
    methods: {
      ...
      // list
      postListData(query) {
        return this.$http.post('order_waitCommunicate', query, { paging: this.paging })
      },
      getList() {
        this.loading = true
