...
export default {
  ...
  methods: {
    ...
    deleteEvent() {
      if (this.learnSituation.length > 1) {
        this.learnSituation.splice(this.clickIndex, 1)
      } else {
        this.query.classRank = ''
        this.query.gradeRank = ''
        this.query.gradeRankStr = ''
        this.query.scores = ''
        this.query.scoresStr = ''
        this.query.scoresTotal = ''
        this.query.subjectId = ''
        this.query.subjectName = ''
        this.query.versionId = ''
        this.query.versionName = ''
        this.query.classRankStr = ''
