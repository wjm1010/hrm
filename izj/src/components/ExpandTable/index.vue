  ...
  <div>
    <el-table
        ...
        <template slot-scope="scope">
          <el-row>
            <el-col :offset="2" :span="6" v-for="(item,index) in tableExpandColumns" :key="index"
              ...
              <el-popover v-if="scope.row[item.value].length>18" trigger="hover" placement="top" width="500">
      ...
      <el-table-column
        ...
        :fixed="cloumn.fixed"
        :width="cloumn.width"
        :label-class-name="cloumn.defineWidth"
...
<style scoped>
  .special-table-hidden-checkbox >>> .define-width
