      ...
      <el-row>
        <el-col :span="7">
          <el-form-item :label="judgeLabel(index)" prop="provinceId">
            <el-select v-model="query.provinceId" clearable @change="provinceChangeEvent" placeholder="省">
              <el-option
        ...
        <el-col :span="4">
          <el-form-item>
            <el-select v-model="query.cityId" clearable @change="cityChangeEvent" placeholder="市" prop="cityId">
              <el-option
        ...
        <el-col :span="4">
          <el-form-item>
            <el-select v-model="query.countryId" clearable placeholder="区" prop="countryId">
              <el-option
        ...
        <el-col :span="4">
          <el-form-item prop="targetSchoolId">
            <el-select
          ...
          <el-button type="primary" @click="schoolSituation(query)" v-if="showSchoolSituation">学校情况</el-button>
          <el-button @click="restFileds">清空</el-button>
      </el-row>
		</div>
	</el-form>
</template>
