  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            value: 'signupLink', text: '电子合同'
          },
          {
            value: 'paperLink', text: '补充协议'
          }
        ],
        tableExpandColumns: [
          { text: '到账金额', value: 'accountingSum' },
          { text: '剩余金额', value: 'restSum' }
        ],
        paging: {
          totalRows: '0',
          page: '1',
    ...
    methods: {
      ...
      getTeacherCommunicationRecordList(params) {
        return this.$http.get('talk_contract', {
...
<style lang="sass" scoped>
  @import '../../../styles/roster/detail/singleMessage'
</style>
