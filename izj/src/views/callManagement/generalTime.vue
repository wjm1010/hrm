    ...
    data() {
      return {
        columns: [
          ...
          { 'value': 'childrenTotal', 'text': '呼叫学生/家长接通总次数' },
          { 'value': 'childrenTimeTotal', 'text': '呼叫学生/家长接通总时长' },
          { 'value': 'teacherTotal', 'text': '呼叫老师接通总次数' },
          { 'value': 'teacherTimeTotal', 'text': '呼叫老师接通总时长' },
          { 'value': 'otherTotal', 'text': '直接输号码拨打接通总次数' },
          { 'value': 'otherTimeTotal', 'text': '直接输号码拨打接通总时长' }
        ],
