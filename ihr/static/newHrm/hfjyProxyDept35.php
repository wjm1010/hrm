  ...
  <div class="proxy">
    ...
    <div id="u99" class="ax_default _文本段落">
      ...
      <div id="u100" class="text">
        ...
        <p><span>1. 培训时间：9个工作日（培训仅安排在工作日，具体以甲方通知为准）。</span></p>
        <p><span>2. 培训方式：线下。</span></p>
        <p><span>第三条：培训补贴</span></p>
        <p><span>1.培训期内甲方为乙方提供培训补贴，支付标准为   50  元/日。</span></p>
        <p><span>2.在培训开始3日内（含3日）自动放弃或被淘汰，提前终止培训的，则不予结算培训补贴。</span></p>
        <p><span>3.如因乙方个人原因在培训开始3日以上提前终止培训，培训补贴按实际参训日折半结算。</span></p>
        <p><span>4.如乙方在规定培训期内无法通过培训考核，甲方决定终止培训的，培训补贴按实际参训日全额结算。</span></p>
        <p><span>5.培训补贴在培训期结束，乙方通过培训考核，正式入职后次月发薪日发放培训补贴。若在培训补贴发放日前提出离职的，培训补贴折半发放。</span></p>
