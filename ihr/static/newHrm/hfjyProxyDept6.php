...
if(!in_array($resumeInfo['resumeTeachingDept'],[3,5,6])){ // 其他
  ...
  <div class="proxy">
    ...
    <div id="u99" class="ax_default _文本段落">
      ...
      <div id="u100" class="text">
        ...
        <p><span>（3）薪金待遇（税前）：</span></p>
        <p><span>1）薪资结构：坐班补贴+课酬,12薪/年 </span></p>
        <p><span>2）.试用期：坐班补贴+课酬（ 保底薪资  <?php
            if(is_numeric($money)){
        ...
        <p>
          <span>3）.转 正：坐班补贴+课酬  （保底薪资  <?php echo $money;?>  元/月,具体保底薪资的定义和执行参考海风教育教师课酬方案） </span></p>
        <p>
                <span>4）.转正奖金：<?php
                  if(is_numeric($money)){
        ...
        <p><span>5）坐班补贴：100元/天（具体详见公司制度）</span></p>
        <p><span>6）午餐补贴：23元/餐 （具体详见公司制度） </span></p>
        <p><span>7）年终奖励：根据公司当年度业绩情况及您的绩效表现而发放。具体发放规定以学科产品中心《全职教师岗位制度》中年度年终奖方案为准。</span></p>
        <br>
