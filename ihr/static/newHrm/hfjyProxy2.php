...
if($resumeInfo['resumeTeachingDept'] == 6){ // 教学四部(哈尔滨)
  header("Location:./hfjyProxyDept6.php?signature=".$signature."&code=".$code);
  exit;
}

if($resumeInfo['resumeTeachingDept'] == 3 || $resumeInfo['resumeTeachingDept'] == 5){ // 教学三部(武汉|西安)
  header("Location:./hfjyProxyDept35.php?signature=".$signature."&code=".$code);
  exit;
}
      ...
      <div class="proxy">
        ...
        <div id="u91" class="ax_default _文本段落">
          ...
          <div id="u92" class="text">
            <p>
  	          ...
  	          <span>本人已查阅《全职教师入培协议及附件》，并同意该培训协议中所有条款，确认无异议</span>
            </p>
          </div>
        </div>
        ...
        <div id="u95" class="ax_default primary_button">
          ...
          <div id="u96" class="text" style="top: 8px; transform-origin: 48.5px 9px 0px;">
            <?php if( !$train_proxy ){ ?><p class="btn sure">已确认, 下一步</p><?php }else{ ?><p class="btn" style="background: #94979a;">已提交</p><?php } ?>
          </div>
        </div>
        ...
        <div id="u99" class="ax_default _文本段落">
          ...
          <div id="u100" class="text">
            ...
            <p><span>1. 甲方根据公司发展的需要为乙方安排培训，乙方应积极参加培训，努力学习并通过所设考试。</span></p><p><span>2.	甲方培训负责部门为  学科产品中心   ，乙方培训通过后甲方录用的岗位为 全职授课教师  。</span></p><p><span>3. 培训期结束并通过培训考试后，甲方应按本合同约定的条件予以录取，并与乙方签订正式的书面劳动合同。（正式劳动合同的约定详见附件）</span></p>
            <p><span>第二条：培训时间与方式</span></p>
            <p><span>1. 培训期：10个工作日（培训仅安排在工作日，具体以甲方通知为准）。</span></p>
            <p><span>2. 培训方式：远程培训。</span></p>
            <p><span>第三条：培训补贴</span></p>
            <p><span>1.	培训期内甲方为乙方提供培训补贴，支付标准如下：</span></p>
            <p><span>1)	乙方通过培训考核并与甲方签订劳动合同、全职授课满一个月的，甲方一次性支付培训补贴人民币300元。培训补贴待乙方全职授课满一个月后随课酬及其他项目（智学派手写板等相应办公用品）在次月一并发放结算；</span></p>
            <p><span>2)	如乙方在培训期内按规定正常培训无法通过考核，甲方决定终止培训的，甲方于本协议终止后的次月一次性支付培训补贴人民币150元；</span></p>
            <p><span>3)	如因乙方个人原因终止培训(包括但不限于在培训期出现失联、不按规定时间提交试卷作业、信息造假等)、乙方通过培训后不与甲方签署劳动合同或乙方通过培训与甲方签署劳动合同但全职授课未满一个月的，则甲方不再支付培训补贴。</span></p>
            <p><span>2.	甲乙双方协商后，一致同意甲方准予延长培训期的，延长的培训期乙方不再享有培训补贴。</span></p>
            <p><span>第四条：培训项目、培训内容及培训考核标准</span></p>
            <p><span>详见本协议附件（由培训实施部门针对培训岗位具体情况拟定）。</span></p>
            <p><span>第五条：甲方责任与义务</span></p>
            <p><span>1. 负责培训内容及目标的设定，负责培训实施与指导。</span></p>
            <p><span>2. 负责为乙方提供必要的培训资源及培训条件。</span></p>
            <p><span>3. 如乙方在培训期结束后考核合格，甲方负责与乙方签订劳动合同，建立劳动关系。</span></p>
            <p><span>第六条：乙方责任与义务</span></p>
            ...
            <p><span>4. 乙方保证在培训考核通过后，根据本协议约定与甲方签订书面劳动合同。</span></p>
            <p><span>第七条：培训协议的变更、解除</span></p>
            ...
            <p><span>第八条：法律效力</span></p>
            <p><span>本协议作为乙方培训通过后，甲、乙双方所签定劳动用工合同的附件，经双方签字盖章，有法律效力，并由甲方在乙方人事档案卷宗中保存。</span></p>
            <p><span>第九条：附则</span></p>
            ...
            <p><span>3. 乙方通过培训后，且不存在任何本协议约定的不予录取的情形的，按照甲方要求提供相关入职文件（体检报告、个人学历、工作经验等背景证明资料等）的前提条件下，甲方将录用乙方为甲方全职授课教师。</span></p>

              <p><span>岗位简介：</span></p>
              <p><span>（1）岗位职责：</span></p>
              <p><span>1）. 参与一对一教学，为学生提供有质量保障的授课；</span></p>
              <p><span>2）. 配合学科负责人做好相应的课程产品宣传准备；</span></p>
              <p><span>3）. 为该学科的教学、教研献言献策，配合学科负责人参与相关学科兼职讲师培训等管理工作；</span></p>
              <p><span>4）. 完成其他由上级交付的相关工作。</span></p>
              ...
              <p><span>4）.有较好的口才表达，能在各个宣传平台上面提供有趣有料的公开课、讲座展示；</span></p>
              <p><span>5）.熟练的办公软件应用，熟练使用各种教学、教研所需的 office 办公软件</span></p>
              <p><span>6）.认真细致，对教学工作一丝不苟，确保提供学科课程产品的专业性和精准度；</span></p>
              <p><span>7）.耐心温和，耐心亲切为学员授课，解决学员的问题，生活上也能对学员有所关心关怀；</span></p>
              <p><span>（3）薪资待遇（税前）：</span></p>
              <p><span>1）.薪资结构：课酬,12薪/年 </span></p>
            <p><span>2）.试用期：课酬 （ 保底薪资  <?php
                if(is_numeric($money)){
                  echo floor($money*0.8);
                }else{
                  echo $money,'*80%';
                };?>   元/月,具体保底薪资的定义和执行参考海风教育教师课酬方案）</span></p>
              <p><span>3）.转 正：课酬 （保底薪资  <?php echo $money;?>  元/月,具体保底薪资的定义和执行参考海风教育教师课酬方案） </span></p>
              <p>
                <span>4）.转正奖金：<?php
                  if(is_numeric($money)){
                    echo floor($money*0.4);
                  }else{
                    echo $money,'*40%';
                  };?>元，转正后的次月发放。
                  <?php if($resumeInfo['resumeTeachingDept'] == 4 || $resumeInfo['resumeTeachingDept'] == 1 || $resumeInfo['resumeTeachingDept'] == 2){ // 教学四部(北京)?>

                  <?php } ?>
                </span>
              </p>
            <p>
                <span>5）.年终奖励：根据公司当年度业绩情况及您的绩效表现而发放。具体发放规定以学科产品中心《全职教师岗位制度》中年度年终奖方案为准。</span>
            </p>
              <br>
              <p><span>具体以双方正式签署的劳动合同内容为准。</span></p>
            <p><span><br /></span></p>
          </div>
        </div>
      ...
      <div class="success">
        ...
        <!-- <div id="u110" class="ax_default primary_button">
          ...
          <div id="u111" class="text" style="top: 8px; transform-origin: 48.5px 9px 0px;">
            <p class="btn" onclick="location.href='./hfjy_proxy.php2?code=<?php echo $resume_id;?>'">返回</p>
          </div>
        </div> -->
      </div>
