  ...
  <div class="dashboard-container">
    ...
    <expandTable :loading="loading"
      ...
      <template slot-scope="scope" slot="operating">
          ...
          <el-button type="text" class="actionItems" @click="accessAdd(scope.row)">新增</el-button>
          ...
          <el-button type="text" class="actionItems" @click="$router.push(`/trench/commonSub/${scope.row.channelId}?channelName=${scope.row.channelName}`)">查看</el-button>
      </template>
...
export default {
  ...
  methods: {
    ...
    stairAdd() {
      ...
      this.dialogTitle = '新增一级渠道'
      this.dialog.channelName = ''
      this.dialog.channelId = ''
    },
    stairEdit(row) {
      this.dialogShow = true
      this.dialogTitle = '编辑一级渠道'
      this.dialog.channelName = row.channelName
      this.dialog.channelId = row.channelId
    },
    /** 二级渠道操作 */
    accessAdd(row) {
      this.dialogShow = true
      this.dialogTitle = '新增二级渠道'
      this.dialog.channelName = ''
      this.dialog.channelPid = row.channelId
      this.dialog.channelId = ''
    },
    /** *渠道提交 */
    submit() {
