...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { 'value': 'resumeInfoTrainDate', 'text': '培训时间' },
        { 'value': 'resumeInfoSignDate', 'text': '签到时间' },
        { 'value': 'userName', 'text': '跟进人' },
        { 'value': 'resumeInfoNextFlowTime', 'text': '下次沟通时间' },
        { 'value': 'resumeUpTime', 'text': '操作时间', sortable: 'custom', width: '120' },
  ...
  computed: {
    ...mapGetters(['userId', 'userRole', 'userLevel', 'checkPhone', 'resume2Option', 'secondDirectOption', 'secondaryChannel'])
  },
  methods: {
    ...mapActions([
      'lookResume2Option',
